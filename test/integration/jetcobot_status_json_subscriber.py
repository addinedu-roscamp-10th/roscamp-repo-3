...
class JetcobotStatusJsonSubscriber(Node):
    """Copy-paste friendly server-side subscriber for Jetcobot JSON status."""

    def __init__(self):
        super().__init__("jetcobot_status_json_subscriber")
...
def main(args=None):
    ...
    node = JetcobotStatusJsonSubscriber()
    try:
        rclpy.spin(node)
