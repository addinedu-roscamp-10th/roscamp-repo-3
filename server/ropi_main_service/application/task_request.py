...
class TaskRequestService:
    ...
    def resume_patrol_task(self, task_id, caregiver_id, member_id, action_memo):
        ...
        try:
            ...
            return self._build_patrol_resume_response(
        ...
        if not FallResponseCommandService.is_accepted(resume_command_response):
            return self._build_patrol_resume_response(
                result_code="NOT_ALLOWED",
                result_message=(
    ...
    async def async_resume_patrol_task(self, task_id, caregiver_id, member_id, action_memo):
        ...
        async_record_resume = getattr(self.repository, "async_record_patrol_task_resume_result", None)
    ...
    def _validate_resume_patrol_task_request(
        ...
        *,
        ...
        if not task_id_text:
            return {
                "error_response": self._build_patrol_resume_response(
                    result_code="NOT_ALLOWED",
    ...
    @staticmethod
    def _build_patrol_resume_response(
        *,
        result_code,
        result_message=None,
        reason_code=None,
