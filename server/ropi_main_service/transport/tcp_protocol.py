...
MESSAGE_CODE_TASK_STATUS_QUERY = 0x1004
...
MESSAGE_CODE_PATROL_FALL_EVIDENCE_QUERY = 0x3003
MESSAGE_CODE_GUIDE_CREATE_TASK = 0x4001
MESSAGE_CODE_GUIDE_RESIDENT_EXISTENCE_QUERY = 0x4008
MESSAGE_CODE_GUIDE_VISITOR_REGISTRATION = 0x4009
MESSAGE_CODE_GUIDE_VISITOR_CARE_HISTORY_QUERY = 0x400A
MESSAGE_CODE_GUIDE_STAFF_CALL_SUBMISSION = 0x400B
...
LEGACY_MESSAGE_CODES = {
    ...
    "TASK_STATUS_QUERY": MESSAGE_CODE_TASK_STATUS_QUERY,
    ...
    "PATROL_FALL_EVIDENCE_QUERY": MESSAGE_CODE_PATROL_FALL_EVIDENCE_QUERY,
    "GUIDE_CREATE_TASK": MESSAGE_CODE_GUIDE_CREATE_TASK,
    "GUIDE_RESIDENT_EXISTENCE_QUERY": MESSAGE_CODE_GUIDE_RESIDENT_EXISTENCE_QUERY,
    "GUIDE_VISITOR_REGISTRATION": MESSAGE_CODE_GUIDE_VISITOR_REGISTRATION,
    "GUIDE_VISITOR_CARE_HISTORY_QUERY": MESSAGE_CODE_GUIDE_VISITOR_CARE_HISTORY_QUERY,
    "GUIDE_STAFF_CALL_SUBMISSION": MESSAGE_CODE_GUIDE_STAFF_CALL_SUBMISSION,
    "FALL_INFERENCE_RESULT_SUBSCRIBE": MESSAGE_CODE_FALL_INFERENCE_RESULT_SUBSCRIBE,
    "FALL_EVIDENCE_IMAGE_QUERY": MESSAGE_CODE_FALL_EVIDENCE_IMAGE_QUERY,
}
