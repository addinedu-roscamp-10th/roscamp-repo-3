...
class RclpyFallResponseControlClient:
    def __init__(
        self,
        *,
        node,
    ...
    def _load_default_service_type():
        try:
            ...
            raise RuntimeError(
                "ropi_interface.srv.FallResponseControl 를 불러올 수 없습니다. "
                "ROS workspace를 build/source 했는지 확인하세요."
            ) from exc

        return FallResponseControl


__all__ = ["RclpyFallResponseControlClient"]
